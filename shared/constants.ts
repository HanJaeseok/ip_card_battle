...
// EXPAND_TURN+1턴(15턴)에 BOMB_BASE_CHANCE로 시작해 턴이 오를 때마다 BOMB_CHANCE_STEP씩 증가한다.
export const BOMB_BASE_CHANCE = 0.3;
export const BOMB_CHANCE_STEP = 0.03;

/** EXPAND_TURN+1턴(15턴)부터 도토리 폭탄이 등장할 확률(0~1). 서버·클라이언트가 동일하게 사용. */
